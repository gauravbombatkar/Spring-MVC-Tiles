...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
	<ul class="nav">
			...
			<div class="nav-link">
				<div class="user-wrapper">
					...
					<div class="text-wrapper">
						<p class="profile-name">Star Admin</p>
						<div>
							<small class="designation text-muted">Manager</small> <span
		...
		<li class="nav-item"><a class="nav-link" href="index.html"> <i
				class="menu-icon mdi mdi-television"></i> <span class="menu-title">Dashboard</span>
		</a></li>
		...
		<li class="nav-item"><a class="nav-link"
			href="viewStudentReg"> <i
				class="menu-icon mdi mdi-backup-restore"></i> <span
				class="menu-title">Sign Up</span>
		</a></li>
		<li class="nav-item"><a class="nav-link"
			href="studentalllist"> <i
				class="menu-icon mdi mdi-backup-restore"></i> <span
				class="menu-title">Student List</span>
		</a></li>
		<li class="nav-item"><a class="nav-link"
			href="pages/charts/chartjs.html"> <i
				class="menu-icon mdi mdi-chart-line"></i> <span class="menu-title">Charts</span>
		</a></li>
		<li class="nav-item"><a class="nav-link"
			href="pages/tables/basic-table.html"> <i
				class="menu-icon mdi mdi-table"></i> <span class="menu-title">Tables</span>
		</a></li>
		<li class="nav-item"><a class="nav-link"
			href="pages/icons/font-awesome.html"> <i
				class="menu-icon mdi mdi-sticker"></i> <span class="menu-title">Icons</span>
		</a></li>
		<li class="nav-item"><a class="nav-link" data-toggle="collapse"
			href="viewStudentTable" aria-expanded="false" aria-controls="auth"> <i
